...
const translations: Record<Language, Record<string, string>> = {
    ar: {
        ...
        'parent.confirmPassword': 'تأكيد كلمة المرور غير متطابق',
        ...
        'parent.manageAccount': 'إدارة حسابك',
        'parent.profile': 'الملف الشخصي',
        'parent.profileDesc': 'إدارة معلوماتك الشخصية',
        'parent.changePhoto': 'تغيير الصورة',
        'parent.noEmailChange': 'لا يمكن تغيير البريد الإلكتروني',
        'parent.saving': 'جاري الحفظ...',
        'parent.notifications': 'الإشعارات',
        'parent.notificationsDesc': 'تحكم في الإشعارات التي تصلك',
        'parent.childActivities': 'نشاطات الطفل',
        'parent.childActivitiesDesc': 'تلقي إشعارات عن أنشطة طفلك',
        'parent.announcements': 'الإعلانات',
        'parent.announcementsDesc': 'تلقي إعلانات الروضة',
        'parent.reminders': 'التذكيرات',
        'parent.remindersDesc': 'تذكيرات الدفع والمواعيد',
        'parent.teacherMessages': 'رسائل المعلمات',
        'parent.teacherMessagesDesc': 'رسائل مباشرة من المعلمات',
        'parent.chooseLanguage': 'اختر لغة التطبيق',
        'parent.security': 'الأمان',
        'parent.changePassword': 'تغيير كلمة المرور',
        'parent.newPassword': 'كلمة المرور الجديدة',
        'parent.confirmPassword': 'تأكيد كلمة المرور',
        'parent.enterNewPassword': 'أدخل كلمة المرور الجديدة',
        'parent.changing': 'جاري التغيير...',
        'parent.change': 'تغيير',
        'parent.photos': 'الصور',
    ...
    fr: {
        ...
        'parent.confirmPassword': 'La confirmation du mot de passe ne correspond pas',
        ...
        'parent.manageAccount': 'Gérer votre compte',
        'parent.profile': 'Profil',
        'parent.profileDesc': 'Gérer vos informations personnelles',
        'parent.changePhoto': 'Changer la photo',
        'parent.noEmailChange': 'L\'email ne peut pas être modifié',
        'parent.saving': 'Enregistrement...',
        'parent.notifications': 'Notifications',
        'parent.notificationsDesc': 'Contrôlez les notifications que vous recevez',
        'parent.childActivities': 'Activités de l\'enfant',
        'parent.childActivitiesDesc': 'Recevoir des notifications sur les activités',
        'parent.announcements': 'Annonces',
        'parent.announcementsDesc': 'Recevoir les annonces du jardin',
        'parent.reminders': 'Rappels',
        'parent.remindersDesc': 'Rappels de paiement et rendez-vous',
        'parent.teacherMessages': 'Messages des enseignantes',
        'parent.teacherMessagesDesc': 'Messages directs des enseignantes',
        'parent.chooseLanguage': 'Choisissez la langue de l\'application',
        'parent.security': 'Sécurité',
        'parent.changePassword': 'Changer le mot de passe',
        'parent.newPassword': 'Nouveau mot de passe',
        'parent.confirmPassword': 'Confirmer le mot de passe',
        'parent.enterNewPassword': 'Entrez votre nouveau mot de passe',
        'parent.changing': 'Modification...',
        'parent.change': 'Changer',
    ...
    en: {
        ...
        'parent.confirmPassword': 'Password confirmation does not match',
        ...
        'parent.manageAccount': 'Manage your account',
        'parent.profile': 'Profile',
        'parent.profileDesc': 'Manage your personal information',
        'parent.changePhoto': 'Change Photo',
        'parent.noEmailChange': 'Email cannot be changed',
        'parent.saving': 'Saving...',
        'parent.notifications': 'Notifications',
        'parent.notificationsDesc': 'Control notifications you receive',
        'parent.childActivities': 'Child Activities',
        'parent.childActivitiesDesc': 'Get notified about activities',
        'parent.announcements': 'Announcements',
        'parent.announcementsDesc': 'Get kindergarten announcements',
        'parent.reminders': 'Reminders',
        'parent.remindersDesc': 'Payment and appointment reminders',
        'parent.teacherMessages': 'Teacher Messages',
        'parent.teacherMessagesDesc': 'Direct messages from teachers',
        'parent.chooseLanguage': 'Choose app language',
        'parent.security': 'Security',
        'parent.changePassword': 'Change Password',
        'parent.newPassword': 'New Password',
        'parent.confirmPassword': 'Confirm Password',
        'parent.enterNewPassword': 'Enter your new password',
        'parent.changing': 'Changing...',
        'parent.change': 'Change',
        'parent.photos': 'Photos',
